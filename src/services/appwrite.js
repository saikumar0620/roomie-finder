...
export const COL_EXPENSES =
  import.meta.env.VITE_COLLECTION_EXPENSES || "expenses";
export const COL_EXPENSE_SHARES =
  import.meta.env.VITE_COLLECTION_EXPENSE_SHARES || "expense_shares";
export const COL_RECURRING_BILLS =
  import.meta.env.VITE_COLLECTION_RECURRING_BILLS || "recurring_bills";
